...
void drawTreemapRectangles(struct RastPort *, struct NodeData *, ULONG, ULONG, ULONG);
void flushAppPort(struct MsgPort *);
float asValue(STRPTR);
float __SAVE_DS__ __ASM__ myCompare(__REG__(a0, struct Hook *), __REG__(a2, Object *),
									   __REG__(a1, struct LBSortMsg *));
int __SAVE_DS__ __ASM__ myCompare2(__REG__(a0, struct Hook *), __REG__(a2, Object *),
									   __REG__(a1, struct LBSortMsg *));
void checkBackButton(char *, BOOL, Object *);
void toggleButtons(Object *, Object *, struct Gadget *, Object *, char *, BOOL, BOOL, BOOL);
void toggleBusyPointer(Object *, BOOL);
void updateBottomTextW2Text(Object *, Object *, char *, STRPTR, BOOL);
void updateBottomTextW2AndTotal(Object *, Object *, char *, STRPTR, STRPTR, BOOL);
